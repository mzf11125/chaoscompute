...
const categories = [
  ...
  },
  {
    ...
    providers: [
      { name: 'Nscale', models: 'Llama 3.3 70B, Llama 4 Scout. $0.01 per 1M tokens.' },
      { name: 'DeepSeek', models: 'deepseek-v4-flash, deepseek-v3.2, deepseek-r1. $0.14 per 1M tokens.' },
      { name: 'Xiaomi MiMo', models: 'mimo-v2.5 ($0.14), mimo-v2.5-pro ($0.43)' },
      { name: 'Hyperbolic', models: 'DeepSeek V3 0324, Qwen 2.5 Coder. $0.20 per 1M tokens.' },
      { name: 'Fireworks AI', models: 'Llama 3.3 70B, DeepSeek V3. $0.20 per 1M tokens.' },
      { name: 'Alibaba Qwen', models: 'qwen3.7-plus, qwen3.6-27b . $0.40 per 1M tokens.' },
      { name: 'DeepInfra', models: 'Llama 3.3 70B . $0.35 per 1M tokens.' },
      { name: 'Cohere', models: 'command-a . $0.50 per 1M tokens.' },
      { name: 'Together AI', models: 'Llama 3.3 70B Turbo, DeepSeek V3 . $0.88 per 1M tokens.' },
      { name: 'MoonshotAI Kimi', models: 'kimi-k2.6 . $0.95 per 1M tokens.' },
  ...
  },
  {
    ...
    providers: [
      { name: 'Groq', models: 'Llama 4 Scout, Qwen 32B. LPU. Fastest inference.' },
      { name: 'Cerebras', models: 'Llama 3.3 70B, Llama 3.1 8B. Wafer-scale chip. Free tier.' },
