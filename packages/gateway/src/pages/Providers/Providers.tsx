...
const categories = [
  {
    title: 'Premium', subtitle: '$1.25-$3.00/1M input, best quality', color: 'bg-foreground/10 text-foreground',
    providers: [
      { name: 'OpenAI', models: 'gpt-4o, o1, o3-mini, gpt-4o-mini' },
      { name: 'Anthropic', models: 'claude-sonnet-4, claude-opus-4, claude-haiku' },
      { name: 'Google Gemini', models: 'gemini-2.5-flash, gemini-2.5-pro' },
      { name: 'xAI Grok', models: 'grok-4, grok-3-mini' },
      { name: 'Mistral', models: 'mistral-large, mistral-small' },
    ],
  },
  {
    title: 'Cheap', subtitle: '$0.01-$0.88/1M input, best price', color: 'bg-warning/20 text-warning',
    providers: [
      { name: 'Nscale', models: 'Llama 3.3 70B, Llama 4 Scout ($0.01/1M)' },
      { name: 'DeepSeek', models: 'deepseek-v3, deepseek-r1 ($0.14/1M)' },
      ...
      { name: 'Perplexity', models: 'sonar-pro (search-augmented, $0.20/1M)' },
      { name: 'Together AI', models: 'Llama 3.3 70B Turbo, DeepSeek V3 ($0.88/1M)' },
      { name: 'OpenRouter', models: 'claude-sonnet-4, gemini-2.5-pro, GLM-5, Kimi K2' },
    ],
  },
  {
