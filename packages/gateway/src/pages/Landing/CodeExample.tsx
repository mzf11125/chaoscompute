...
const stats = [
  { icon: Terminal, value: '1 command', label: 'Install' },
  { icon: Globe, value: '40+', label: 'Providers' },
  { icon: Shield, value: 'HTTP 402', label: 'Payment Layer' },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-text-secondary mb-8 max-w-lg mx-auto">
            Install pay.sh. Point at our endpoint. Your wallet handles the rest. Production-ready in 5 minutes.
          </p>
          <a
